...
| Agent Plugins | Co-authored the vendor-neutral plugin packaging spec (v1.0.0, Aug 2026); Amazon holds a Core Maintainer seat and Kiro is listed among supporting clients | [Standards/agent-plugins.md](../Standards/agent-plugins.md) |
