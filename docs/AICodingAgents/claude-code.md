...
- [Agent Plugins Specification](../Standards/agent-plugins.md) — vendor-neutral plugin packaging standard; defines a migration path for Claude Code–style manifests carrying `hooks`, `agents`, `commands`, and `mcpServers`
