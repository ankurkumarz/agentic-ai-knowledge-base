---
type: Playbook
title: LangGraph Context Engineering
description: Lance Martin (LangChain) has been one of the most active voices synthesizing context engineering patterns across the industry
