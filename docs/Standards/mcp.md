...
- [Agent Plugins Specification](./agent-plugins.md) — declares MCP servers in a plugin-local `mcp.json` (stdio, streamable-http, legacy sse) alongside packaged skills
