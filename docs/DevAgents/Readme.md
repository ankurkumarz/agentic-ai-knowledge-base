...
- [Deep Agents](https://github.com/langchain-ai/deepagents): LangGraph community-driven, most of the Claude code features without vendor lock-in such as Subagents, Skills. ``` deepagents ```
